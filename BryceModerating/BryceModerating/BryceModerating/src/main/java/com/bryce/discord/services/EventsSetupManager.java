...
public class EventsSetupManager {
    ...
    public void startSetupSession(String guildId, String userId) {
        ...
        System.out.println("Started setup session for guild: " + guildId);
    }
    ...
    public void completeSetupSession(String guildId) {
        ...
        System.out.println("Completed setup session for guild: " + guildId);
    }
    ...
    public void saveSetup(String guildId) {
        ...
        if (session != null) {
            ...
            database.saveServerSetup(guildId, categoryId, vcIdsStr);
            System.out.println("Saved setup for guild: " + guildId + " with category: " + categoryId + " and VCs: " + vcIdsStr);
        }
    }
    ...
    public List<String> getManagedVoiceChannels(String guildId) {
        String vcIdsStr = database.getManagedVcIds(guildId);
